...
namespace EventSourcing.API.BackgroundServices
{
    public class ProductReadModelEventStore : BackgroundService
    {
        ...
        private async Task EventAppeared(EventStorePersistentSubscriptionBase arg1, ResolvedEvent arg2)
        {
            ...
            string eventData = Encoding.UTF8.GetString(arg2.Event.Data);
            ...
            //EventStore'a eventi dinlediğimizi manuel olarak bu şekilde bilgilendiririz.
            //Otomatik olarak yapılması için yukarıda eventstoreconnection oluşturulurken autoAck: true set edilir.
            //İçinde bulunduğumuz methodda herhangi bir exception fırlatılmamışsa Event Store eventi gönderildi kabul eder.
        }
